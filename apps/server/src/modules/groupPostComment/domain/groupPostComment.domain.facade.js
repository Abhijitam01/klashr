...
let GroupPostCommentDomainFacade = class GroupPostCommentDomainFacade {
    repository;
    databaseHelper;
    ...
    async findManyByGroupPost(item, queryOptions = {}) {
        if (!item) {
...
GroupPostCommentDomainFacade = __decorate([
    Injectable(),
    __param(0, InjectRepository(GroupPostComment)),
    __metadata("design:paramtypes", [Repository,
        DatabaseHelper])
], GroupPostCommentDomainFacade);
export { GroupPostCommentDomainFacade };
