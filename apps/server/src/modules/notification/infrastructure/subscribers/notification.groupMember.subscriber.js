...
import { GroupMemberApplicationEvent } from "../../../groupMember/application";
import { AuthorizationDomainFacade } from "../../../authorization/domain";
import { NotificationDomainFacade, } from "../../domain";
let NotificationGroupMemberSubscriber = class NotificationGroupMemberSubscriber {
...
], NotificationGroupMemberSubscriber.prototype, "handleCreation", null);
NotificationGroupMemberSubscriber = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [NotificationDomainFacade,
        AuthorizationDomainFacade,
        SocketService])
], NotificationGroupMemberSubscriber);
export { NotificationGroupMemberSubscriber };
