...
import { GroupApplicationEvent } from "../../../group/application";
import { AuthorizationDomainFacade } from "../../../authorization/domain";
import { NotificationDomainFacade, } from "../../domain";
let NotificationGroupSubscriber = class NotificationGroupSubscriber {
...
__decorate([
    OnEvent(GroupApplicationEvent.GroupCreated.key),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], NotificationGroupSubscriber.prototype, "handleCreation", null);
NotificationGroupSubscriber = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [NotificationDomainFacade,
        AuthorizationDomainFacade,
        SocketService])
], NotificationGroupSubscriber);
export { NotificationGroupSubscriber };
