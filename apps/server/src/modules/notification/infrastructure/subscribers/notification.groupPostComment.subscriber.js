...
import { GroupPostCommentApplicationEvent } from "../../../groupPostComment/application";
import { AuthorizationDomainFacade } from "../../../authorization/domain";
import { NotificationDomainFacade, } from "../../domain";
let NotificationGroupPostCommentSubscriber = class NotificationGroupPostCommentSubscriber {
    ...
    async handleCreation(data) {
        const values = {
            title: 'Admin',
            message: 'A new groupPostComment has been created',
            senderName: 'API',
        };
...
__decorate([
    OnEvent(GroupPostCommentApplicationEvent.GroupPostCommentCreated.key),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], NotificationGroupPostCommentSubscriber.prototype, "handleCreation", null);
NotificationGroupPostCommentSubscriber = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [NotificationDomainFacade,
        AuthorizationDomainFacade,
        SocketService])
], NotificationGroupPostCommentSubscriber);
export { NotificationGroupPostCommentSubscriber };
