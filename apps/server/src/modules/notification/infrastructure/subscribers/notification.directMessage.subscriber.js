...
import { DirectMessageApplicationEvent } from "../../../directMessage/application";
import { AuthorizationDomainFacade } from "../../../authorization/domain";
import { NotificationDomainFacade, } from "../../domain";
let NotificationDirectMessageSubscriber = class NotificationDirectMessageSubscriber {
...
], NotificationDirectMessageSubscriber.prototype, "handleCreation", null);
NotificationDirectMessageSubscriber = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [NotificationDomainFacade,
        AuthorizationDomainFacade,
        SocketService])
], NotificationDirectMessageSubscriber);
export { NotificationDirectMessageSubscriber };
