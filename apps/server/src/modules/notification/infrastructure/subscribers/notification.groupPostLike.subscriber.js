...
import { GroupPostLikeApplicationEvent } from "../../../groupPostLike/application";
import { AuthorizationDomainFacade } from "../../../authorization/domain";
import { NotificationDomainFacade, } from "../../domain";
let NotificationGroupPostLikeSubscriber = class NotificationGroupPostLikeSubscriber {
...
], NotificationGroupPostLikeSubscriber.prototype, "handleCreation", null);
NotificationGroupPostLikeSubscriber = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [NotificationDomainFacade,
        AuthorizationDomainFacade,
        SocketService])
], NotificationGroupPostLikeSubscriber);
export { NotificationGroupPostLikeSubscriber };
