...
import { LikeApplicationEvent } from "../../../like/application";
import { AuthorizationDomainFacade } from "../../../authorization/domain";
import { NotificationDomainFacade, } from "../../domain";
let NotificationLikeSubscriber = class NotificationLikeSubscriber {
...
], NotificationLikeSubscriber.prototype, "handleCreation", null);
NotificationLikeSubscriber = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [NotificationDomainFacade,
        AuthorizationDomainFacade,
        SocketService])
], NotificationLikeSubscriber);
export { NotificationLikeSubscriber };
