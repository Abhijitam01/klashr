...
let GroupMemberByUserController = class GroupMemberByUserController {
    userDomainFacade;
    groupMemberDomainFacade;
    eventService;
    authenticationDomainFacade;
    constructor(userDomainFacade, groupMemberDomainFacade, eventService, authenticationDomainFacade) {
    ...
    async findManyUserId(userId, request) {
        ...
        const items = await this.groupMemberDomainFacade.findManyByUser(parent, queryOptions);
        return items;
    }
...
], GroupMemberByUserController.prototype, "findManyUserId", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], GroupMemberByUserController.prototype, "createByUserId", null);
GroupMemberByUserController = __decorate([
    Controller('/v1/users'),
...
export { GroupMemberByUserController };
