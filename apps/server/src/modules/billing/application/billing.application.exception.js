...
let BillingApplicationException = class BillingApplicationException {
    service;
    constructor(service) {
...
BillingApplicationException = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [ExceptionService])
], BillingApplicationException);
export { BillingApplicationException };
