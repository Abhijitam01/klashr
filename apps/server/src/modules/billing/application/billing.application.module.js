...
import { PaymentModule } from "../../../libraries/payment/payment.module";
...
let BillingApplicationModule = class BillingApplicationModule {
};
BillingApplicationModule = __decorate([
    Module({
        imports: [
            HttpModule,
            UploadModule,
...
export { BillingApplicationModule };
