...
let GroupPostLikeDomainFacade = class GroupPostLikeDomainFacade {
    repository;
    databaseHelper;
...
GroupPostLikeDomainFacade = __decorate([
    Injectable(),
    __param(0, InjectRepository(GroupPostLike)),
    __metadata("design:paramtypes", [Repository,
        DatabaseHelper])
], GroupPostLikeDomainFacade);
export { GroupPostLikeDomainFacade };
