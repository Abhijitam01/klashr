...
let CommentDomainFacade = class CommentDomainFacade {
    repository;
    databaseHelper;
    ...
    async findManyByPost(item, queryOptions = {}) {
        if (!item) {
...
CommentDomainFacade = __decorate([
    Injectable(),
    __param(0, InjectRepository(Comment)),
    __metadata("design:paramtypes", [Repository,
        DatabaseHelper])
], CommentDomainFacade);
export { CommentDomainFacade };
