...
let AuthorizationDomainFacade = class AuthorizationDomainFacade {
    code;
    role;
    roleUser;
    constructor(code, role, roleUser) {
        this.code = code;
        this.role = role;
        this.roleUser = roleUser;
    }
};
AuthorizationDomainFacade = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [AuthorizationCodeFacade,
        AuthorizationRoleFacade,
        AuthorizationRoleUserFacade])
], AuthorizationDomainFacade);
export { AuthorizationDomainFacade };
