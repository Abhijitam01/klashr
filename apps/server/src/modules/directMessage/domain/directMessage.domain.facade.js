...
let DirectMessageDomainFacade = class DirectMessageDomainFacade {
    repository;
    databaseHelper;
...
DirectMessageDomainFacade = __decorate([
    Injectable(),
    __param(0, InjectRepository(DirectMessage)),
    __metadata("design:paramtypes", [Repository,
        DatabaseHelper])
], DirectMessageDomainFacade);
export { DirectMessageDomainFacade };
